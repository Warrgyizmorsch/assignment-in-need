...
export default function SubjectLanding({
  ...
  let subject = SUBJECTS.find(
    (s) => s.slug === cleanSlugForSubject || s.slug === slug,
  );
  if (!subject) {
    const humanName =
  ...
  const mapExpertToWriterLocal = (expert: any) => {
    ...
    if (
      expert.image &&
      !expert.image.includes("blank.png") &&
      !expert.image.includes("ui-avatars.com")
    ) {
        ...
        <div className="relative z-10 max-w-[1250px] mx-auto">
          ...
          <div className="flex items-center gap-1.5 text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-6">
            ...
            <span className="text-gray-550">
              {pageData?.hero_heading?.replace(/ Help$/, " Help") ||
        ...
        <div className="max-w-[1250px] mx-auto px-4">
          <div className="text-center mb-10 max-w-3xl mx-auto flex flex-col gap-2">
            <h2 className="text-[22px] md:text-[28px] font-black text-[#0f1b3d] tracking-tight font-heading leading-tight">
              Why Students Choose{" "}
              <span className="text-[#3f159a]">
                {whyHeading.replace("Why Students Choose ", "")}
              </span>
            </h2>
            {whySubheading && (
          ...
          {sectionTwoContent ? (
            <div className="flex flex-col gap-4 text-left max-w-4xl mx-auto html-desc select-text">
              ...
              {sectionThreeContent && (
                <>
                  {sectionThreeHeading && (
                    <h3 className="text-xl md:text-2xl font-bold text-[#0f1b3d] tracking-tight mt-6">
                      {sectionThreeHeading}
                    </h3>
                  )}
                  <div
            ...
            <>
              <p className="text-[15px] text-gray-600 font-bold leading-relaxed max-w-3xl mx-auto mb-6">
                ...
                several benefits that add value to their service. So, do you
                want to know such valuable benefits that explain why seeking our
                assistance is the right decision to make? Continue reading to
                learn about it!
              </p>
            ...
            <div className="max-w-[900px] mx-auto px-4">
              <div className="text-center mb-8">
                ...
                <p className="text-xs text-gray-500 font-medium">
                  Find answers to common questions about our {subject.name}{" "}
